...
public class TrelloJsonParserTest
{
	...
	{
		Backlog backlog = trelloJsonParser.parse(mapper.readValue(RetrieveTestData.getExportedTrelloJSONTestResultFromResource(), mapper.getTypeFactory().constructCollectionType(LinkedList.class, TrelloJsonIssue.class)));
