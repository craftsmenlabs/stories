...
public class SummaryTest {
    ...
    public void divideBy() throws Exception {
        Summary s = Summary.builder()
            ...
            .teamTask(BacklogItemListSummary.builder().passed(50).failed(70).count(120).build())
        ...
        Summary result = Summary.builder()
            ...
            .teamTask(BacklogItemListSummary.builder().passed(5).failed(7).count(12).build())
    ...
    public void plus() throws Exception {
        ...
        Summary c = Summary.builder()
                ...
                .teamTask(BacklogItemListSummary.builder().passed(55).failed(77).count(132).build())
