...
public class StoriesException extends RuntimeException {
    public static final String ERR_SOURCE_ENABLED_MISSING = "Parameter source.enabled should be configured with one of the supported sources. For example: trello, jira, etc. Please check your config or parameters.";
